...
export const PLAYER_ATTACK_RANGE = 160; // pixels
...
export const PLAYER_COLLISION_RADIUS = 70;
...
export const MELEE_MINION_ATTACK_RANGE = 70;
export const MELEE_MINION_ATTACK_COOLDOWN = 1500; // ms
export const MELEE_MINION_COLLISION_RADIUS = 50;
...
export const CASTER_MINION_COLLISION_RADIUS = 40;
